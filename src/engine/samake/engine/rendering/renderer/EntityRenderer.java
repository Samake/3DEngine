...
import samake.engine.rendering.shader.EntityShader;
...
public class EntityRenderer {
	...
	public EntityRenderer() throws Exception {
		...
		Console.print("EntityRenderer loaded!", LOGTYPE.OUTPUT, true);
	}
	...
	public void render(Camera camera, Transformation transformation, Scene scene, int renderMode, Vector4f clipPlane) {
		if (!scene.getEntities().isEmpty()) {
	    	...
	    	for (Entity entity : scene.getEntities()) {
	    		Matrix4f transformationMatrix = transformation.getWorldMatrix(entity.getPosition(), entity.getRotation(), entity.getScale());
